...
export const SleepingCompartments = {
    ...
    paragraphs: [
        {text: <p>{`(a) Sleeping compartments required to be accessible shall be designed so as to allow a person using a wheelchair or mobility aid to enter, maneuver within and approach and use each element within such compartment. (See Fig. 5.)`}</p>},
        {text: <p>{`(b) Each accessible compartment shall contain a restroom complying with §38.123(a) which can be entered directly from such compartment.`}</p>},
