const APTA_BaseURL = "https://www.apta.com";
const CFR_BaseURL = "https://www.ecfr.gov";
const ADA_BaseURL = "https://www.ada.gov";

interface LinkName {
    readonly [propName: string]: LinkDetails;
}
